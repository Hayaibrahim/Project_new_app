...
public class QueryUtils {
    ...
    public static List<News> fetch(String requestUrl) {
    ...
    private static String HttpRequest(URL url) throws IOException {
        ...
        try {
            ...
            Log.e(LOG_TAG, "Problem the JSON ", e);
        } finally {
    ...
    private static List<News> extractInfoFromJson(String mJSON) {
        ...
        try {
            JSONObject baseJsonResponse = new JSONObject(mJSON);
